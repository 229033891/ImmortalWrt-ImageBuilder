...
# 确保首启脚本与同步脚本可执行（Windows 提交时可能丢失 +x）
chmod +x /home/build/immortalwrt/files/etc/uci-defaults/* 2>/dev/null || true
chmod +x /home/build/immortalwrt/files/usr/bin/sftp-sync.sh 2>/dev/null || true
